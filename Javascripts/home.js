...
const historyBtn = document.getElementById('menu-history-button');
...
addSafeNavigation(historyBtn, 'history.html');
addSafeNavigation(homeBtn, 'index.html');
addSafeNavigation(logoEl, 'index.html', 'logo');

if (logoutBtn) {
  logoutBtn.addEventListener('click', (e) => {
    e.preventDefault();
    localStorage.removeItem('bubbleBoothUser');
